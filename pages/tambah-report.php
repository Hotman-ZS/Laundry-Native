        ...
        <div class="card-header">
          ...
          <div class="card-body">
            <form action="" method="post">
              ...
              <input placeholder="Isi Icon" type="text" class="form-control w-50 mb-2" name="customer_id" value="<?php echo $report['customer_id'] ?? '' ?>">
              <label for="" class="form-label">Order Code</label><br>
              <input placeholder="Isi Link" type="text" class="form-control w-50 mb-2" name="order_code" value="<?php echo $report['order_code'] ?? '' ?>">
              <label for="" class="form-label">Order Status</label><br>
              <input placeholder="Isi nama Order" type="text" class="form-control w-50 mb-2" name="order_status" value="<?php echo $report['order_status'] ?? '' ?>">
              <label for="" class="form-label">Order Pay</label><br>
              <input placeholder="Isi nama Menu" type="text" class="form-control w-50 mb-2" name="order_pay" value="<?php echo $report['order_pay'] ?? '' ?>">
              <label for="" class="form-label">Order Change</label><br>
              <input placeholder="Isi Icon" type="text" class="form-control w-50 mb-2" name="order_change" value="<?php echo $report['order_change'] ?? '' ?>">
              <label for="" class="form-label">Order Tax</label><br>
              <input placeholder="Isi Link" type="text" class="form-control w-50 mb-2" name="order_tax" value="<?php echo $report['order_tax'] ?? '' ?>">
              <label for="" class="form-label">Order Total</label><br>
              <input placeholder="Isi nama Order" type="text" class="form-control w-50 mb-2" name="order_total" value="<?php echo $report['order_total'] ?? '' ?>">
